...
@Service
public class PdfConversionService extends AbstractConversionService implements ConversionService {
    @Override
    public String convert(String filename, Boolean adjustToWidestPage, 
        ...
        String outputFileName = generateOutputFileName(filename, "pdf");
