...
public class SpecifyCustomStreamProvider__5 {

    @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Timeout(value = 50, unit = java.util.concurrent.TimeUnit.SECONDS)
    public void execute() throws Exception {
        // @START_SNIPPET ConvertEPUBToXPS_SpecifyCustomStreamProvider
        ...
        // @END_SNIPPET
        Assertions.assertTrue(File.exists($o("stream-provider.xps")));
    }
}
