...
public class WebAccessibilityRules {
    ...
    public final void checkHTMLAgainstSpecificWebAccessibilityRulesTest() {
        // @START_SNIPPET CheckHTMLAgainstSpecificWebAccessibilityRules
