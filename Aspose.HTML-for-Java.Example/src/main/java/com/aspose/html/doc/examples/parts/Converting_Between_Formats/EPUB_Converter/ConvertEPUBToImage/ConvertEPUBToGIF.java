...
public class ConvertEPUBToGIF {

    @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Timeout(value = 50, unit = java.util.concurrent.TimeUnit.SECONDS)
    public void execute() throws Exception {
        // @START_SNIPPET ConvertEPUBToImage_ConvertEPUBToGIF
        ...
        Converter.convertEPUB(fileInputStream, options, $o("output.gif"));
        // @END_SNIPPET
        Assertions.assertTrue(File.exists($o("output.gif")));
    }
}
