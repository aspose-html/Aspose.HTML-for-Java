...
public class SpecifyCustomStreamProvider__1 {

    @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Timeout(value = 50, unit = java.util.concurrent.TimeUnit.SECONDS)
    public void execute() throws Exception {
        // @START_SNIPPET ConvertHTMLToDOCX_SpecifyCustomStreamProvider
        ...
        java.io.File fs = new java.io.File($o("stream-provider.docx"));
        FileHelper.save(memory, fs);
        // @END_SNIPPET
        // Assertions.assertTrue(File.exists("stream-provider.docx"));
    }
}
