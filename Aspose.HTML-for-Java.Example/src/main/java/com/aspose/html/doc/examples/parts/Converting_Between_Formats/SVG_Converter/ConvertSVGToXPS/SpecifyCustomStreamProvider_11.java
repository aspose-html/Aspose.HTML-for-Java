...
public class SpecifyCustomStreamProvider_11 {

    @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Timeout(value = 50, unit = java.util.concurrent.TimeUnit.SECONDS)
    public void execute() throws Exception {
        // @START_SNIPPET ConvertSVGToXPS_SpecifyCustomStreamProvider
        ...
        Converter.convertSVG(document, new XpsSaveOptions(), streamProvider.lStream);
