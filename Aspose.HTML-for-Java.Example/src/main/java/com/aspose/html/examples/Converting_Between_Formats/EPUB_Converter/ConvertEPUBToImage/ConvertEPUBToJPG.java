...
public class ConvertEPUBToJPG {

    @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Timeout(value = 50, unit = java.util.concurrent.TimeUnit.SECONDS)
    public void execute() throws Exception {
        // @START_SNIPPET Example_ConvertEpubToJpegImage.java
        ...
        Converter.convertEPUB(fileInputStream, options, $o("input-output.jpg"));
        // @END_SNIPPET
        Assertions.assertTrue(File.exists($o($o("input-output.jpg"))));
    }
}